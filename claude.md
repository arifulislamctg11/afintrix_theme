...
This is a theme to build for making from a whitelabeling ERPnext with the brand name of a Afintricks.
...
Unless mentioned, the site is afintrix.localhost with Administrator/admin credentials.
